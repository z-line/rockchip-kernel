...
void rtl8723du_req_txrpt_cmd(_adapter *padapter, u8 macid)
{
	u8 u1H2CApReqRptParm[H2C_AP_REQ_TXRPT_LEN] = {0};

	SET_8723D_H2CCMD_APREQRPT_PARM_MACID1(u1H2CApReqRptParm, macid);
	SET_8723D_H2CCMD_APREQRPT_PARM_MACID2(u1H2CApReqRptParm, 0xff);
	SET_8723D_H2CCMD_APREQRPT_PARM_RTY(u1H2CApReqRptParm, 0x00);
	FillH2CCmd8723D(padapter, H2C_AP_REQ_TXRPT, H2C_AP_REQ_TXRPT_LEN, u1H2CApReqRptParm);
	SET_8723D_H2CCMD_APREQRPT_PARM_RTY(u1H2CApReqRptParm, 0x02);
	FillH2CCmd8723D(padapter, H2C_AP_REQ_TXRPT, H2C_AP_REQ_TXRPT_LEN, u1H2CApReqRptParm);
}
...
#endif
	pHalFunc->reqtxrpt = &rtl8723du_req_txrpt_cmd;
